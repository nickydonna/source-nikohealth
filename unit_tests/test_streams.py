...
import pytest
from source_nikohealth.source import NikohealthStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(NikohealthStream, "path", "v0/example_endpoint")
    mocker.patch.object(NikohealthStream, "primary_key", "test_primary_key")
    mocker.patch.object(NikohealthStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = NikohealthStream()
